...
ПРОЕКТ
    ...
    системы на чтение и запись для реализации резервного копирования Snapshot.
    Библиотеку можно использовать как и в режиме ядра, так и в режиме
    пользователя.
...
ИНТЕРФЕЙС УТИЛИТЫ
    ...
    snapshot p - подготовить интервал для записи
